...
static syscall_t table[] = {
    {0, "read", 3, NUM, NUM, SIZED_PTR, NUM, 0, 0, 0},
    {1, "write", 3, NUM, NUM, SIZED_PTR, NUM, 0, 0, 0},
    ...
    {13, "rt_sigaction", 6, NUM, CONST_STRUCT_SIGACTION_P, STRUCT_SIGACTION_P,
        0, 0, 0, 0},
    ...
    {26, "msync", 3, NUM, SIZED_PTR, NUM, NUM, 0, 0, 0},
    {27, "mincore", 3, NUM, SIZED_PTR, NUM, STRING, 0, 0, 0},
    {28, "madvise", 3, NUM, SIZED_PTR, NUM, NUM, 0, 0, 0},
    ...
    {54, "setsockopt", 5, NUM, NUM, NUM, NUM, CONST_SIZED_PTR, SOCKLEN_T, 0},
    {55, "getsockopt", 5, NUM, NUM, NUM, NUM, SIZED_PTR, SOCKLEN_T_P, 0},
    {56, "clone", 0, NUM, 0, 0, 0, 0, 0, 0},
    {57, "fork", 1, NUM, VOID, 0, 0, 0, 0, 0},
    {58, "vfork", 1, NUM, VOID, 0, 0, 0, 0, 0},
    {59, "execve", 3, NUM, STRING, STRING_TAB, STRING_TAB, 0, 0, 0},
    ...
    {69, "msgsnd", 4, NUM, NUM, CONST_SIZED_PTR, NUM, NUM, 0, 0},
    {70, "msgrcv", 5, NUM, NUM, SIZED_PTR, NUM, NUM, NUM, 0},
    ...
    {148, "sched_rr_get_interval", 2, NUM, NUM, STRUCT_TIMESPEC_P_,
        0, 0, 0, 0},
    {149, "mlock", 2, NUM, CONST_SIZED_PTR, NUM, 0, 0, 0, 0},
    {150, "munlock", 2, NUM, CONST_SIZED_PTR, NUM, 0, 0, 0, 0},
    {151, "mlockall", 1, NUM, NUM, 0, 0, 0, 0, 0},
    {152, "munlockall", 1, NUM, VOID, 0, 0, 0, 0, 0},
    {153, "vhangup", 1, NUM, VOID, 0, 0, 0, 0, 0},
    {154, "modify_ldt", 3, NUM, NUM, SIZED_PTR, UNSIGNED, 0, 0, 0},
    ...
    {175, "init_module", 3, NUM, SIZED_PTR, UNSIGNED, STRING, 0, 0, 0},
    {176, "delete_module", 2, NUM, STRING, NUM, 0, 0, 0, 0},
    {177, "get_kernel_syms", 1, NUM, STRUCT_KERNEL_SYM_P, 0, 0, 0, 0, 0},
    {178, "query_module", 5, NUM, STRING, NUM, SIZED_PTR, NUM, NUM_P, 0},
    ...
    {188, "setxattr", 5, NUM, STRING, STRING, CONST_SIZED_PTR, NUM, NUM, 0},
    {189, "lsetxattr", 5, NUM, STRING, STRING, CONST_SIZED_PTR, NUM, NUM, 0},
    {190, "fsetxattr", 5, NUM, NUM, STRING, CONST_SIZED_PTR, NUM, NUM, 0},
    {191, "getxattr", 4, NUM, STRING, STRING, SIZED_PTR, NUM, 0, 0},
    {192, "lgetxattr", 4, NUM, STRING, STRING, SIZED_PTR, NUM, 0, 0},
    {193, "fgetxattr", 4, NUM, NUM, STRING, SIZED_PTR, NUM, 0, 0},
    ...
    {216, "remap_file_pages", 5, NUM, SIZED_PTR, NUM, NUM, NUM, NUM, 0},
    ...
    {237, "mbind", 6, NUM, SIZED_PTR, UNSIGNED, NUM, CONST_UNSIGNED_P,
        UNSIGNED, UNSIGNED},
    ...
    {248, "add_key", 5, KEY_SERIAL_T, STRING, STRING, CONST_SIZED_PTR, NUM,
        KEY_SERIAL_T, 0},
    ...
    {273, "set_robust_list", 2, NUM, STRUCT_ROBUST_LIST_HEAD_P, NUM,
        0, 0, 0, 0},
    ...
    {318, "getrandom", 3, NUM, SIZED_PTR, NUM, UNSIGNED, 0, 0, 0},
    ...
    {325, "mlock2", 3, NUM, CONST_SIZED_PTR, NUM, NUM, 0, 0, 0},
    ...
    // syscall ajouté:
    {329, "pkey_mprotect", 4, NUM, VOID_P, UNSIGNED, NUM, NUM, 0, 0},
    {330, "pkey_alloc", 2, NUM, UNSIGNED, UNSIGNED, 0, 0, 0, 0},
    {331, "pkey_free", 1, NUM, NUM, 0, 0, 0, 0, 0},
    {332, "statx", 5, NUM, NUM, STRING, NUM, UNSIGNED, 0, 0},
        //Attention macro manquante : struct statx !
    {333, "io_pgetevents", 6, 0, 0, 0, 0, 0, 0, 0}, // Man inexistant
    {334, "rseq", 4, NUM, 0, NUM, NUM, NUM, 0, 0},
        /// Structure manquante en 1er param: (struct rseq
    {424, "pidfd_send_signal", 5, NUM, NUM, NUM, 0, UNSIGNED, 0, 0},
        /// Structure manquante 4ieme param: siginfo_t *
    {425, "io_uring_setup", 2, NUM, NUM, 0, 0, 0, 0, 0},
        /// Structure manquante 2nd param: struct io_uring_params *
    {426, "io_uring_enter", 5, NUM, UNSIGNED, UNSIGNED, UNSIGNED, UNSIGNED,
        0, 0}, //Structure manquante 5ieme param: sigset_t *
    {427, "io_uring_register", 4, NUM, UNSIGNED, UNSIGNED, VOID_P, UNSIGNED,
        0, 0},
    {428, "open_tree", 6, 0, 0, 0, 0, 0, 0, 0},
    {429, "move_mount", 6, 0, 0, 0, 0, 0, 0, 0},
    {430, "fsopen", 2, NUM, STRING, UNSIGNED, 0, 0, 0, 0},
    {431, "fsconfig", 5, NUM, NUM, UNSIGNED, STRING, VOID_P, NUM, 0},
    {432, "fsmount", 3, NUM, NUM, UNSIGNED, UNSIGNED, 0, 0, 0},
    {433, "fspick", 3, NUM, NUM, STRING, UNSIGNED, 0, 0, 0},
    {434, "pidfd_open", 6, 0, 0, 0, 0, 0, 0, 0},
    {435, "clone3", 6, 0, 0, 0, 0, 0, 0, 0},
    {436, "close_range", 6, 0, 0, 0, 0, 0, 0, 0},
    {437, "openat2", 4, NUM, NUM, STRING, 0, UNSIGNED, 0, 0},
    {438, "pidfd_getfd", 6, 0, 0, 0, 0, 0, 0, 0},
    {439, "faccessat2", 4, NUM, NUM, STRING, NUM, NUM, 0, 0},
    {440, "process_madvise", 6, 0, 0, 0, 0, 0, 0, 0},
    {441, "epoll_pwait2", 6, 0, 0, 0, 0, 0, 0, 0},
    {442, "mount_setattr", 6, 0, 0, 0, 0, 0, 0, 0},
    {443, "quotactl_fd", 6, 0, 0, 0, 0, 0, 0, 0},
    {444, "landlock_create_ruleset", 6, 0, 0, 0, 0, 0, 0, 0},
    {445, "landlock_add_rule", 6, 0, 0, 0, 0, 0, 0, 0},
    {446, "landlock_restrict_self", 6, 0, 0, 0, 0, 0, 0, 0},
    {447, "memfd_secret", 6, 0, 0, 0, 0, 0, 0, 0},
    {448, "process_mrelease", 6, 0, 0, 0, 0, 0, 0, 0},
    {449, "futex_waitv", 6, 0, 0, 0, 0, 0, 0, 0},
    {450, "set_mempolicy_home_node", 6, 0, 0, 0, 0, 0, 0, 0},
    {451, "cachestat", 6, 0, 0, 0, 0, 0, 0, 0},
    {452, "fchmodat2", 6, 0, 0, 0, 0, 0, 0, 0},
    {453, "map_shadow_stack", 6, 0, 0, 0, 0, 0, 0, 0},
    {454, "futex_wake", 6, 0, 0, 0, 0, 0, 0, 0},
    {455, "futex_wait", 6, 0, 0, 0, 0, 0, 0, 0},
    {456, "futex_requeue", 6, 0, 0, 0, 0, 0, 0, 0},

    {-1, NULL, 0, 0, 0, 0, 0, 0, 0, 0}};


    #define NB_SYSCALL sizeof(table) / sizeof(syscall_t)
