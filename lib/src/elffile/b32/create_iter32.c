...
elf_tab_it_t create_shdr_iter_b32(elffile_t *elf)
{
    ...
    it.nmem = EHDR32(elf)->e_shnum;
    it.size_hdr = sizeof(Elf32_Shdr);
...
elf_tab_it_t create_phdr_iter_b32(elffile_t *elf)
{
    ...
    it.nmem = EHDR32(elf)->e_phnum;
    it.size_hdr = sizeof(Elf32_Phdr);
...
elf_tab_it_t create_symtab_iter_b32(elffile_t *elf)
{
    ...
    it.nmem = symtable_hdr->sh_size / sizeof(Elf32_Sym);
    it.size_hdr = sizeof(Elf32_Sym);
